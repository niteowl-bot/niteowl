...
function buildSummaryInstructions(): string {
  return [
    ...
    "",
    "Write two or three short sentences saying who called and what they wanted. Then, in the same paragraph, give these six details in this order, each written as \"Label: value\" and separated by full stops: Name, Callback number, the date, the time, Address, Issue.",
