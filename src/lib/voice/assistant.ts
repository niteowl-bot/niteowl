...
function buildVoiceSystemPrompt(
  ...
  sections.push(
    [
      ...
      "8. Clarify a service name you are unsure of BEFORE acting on it — speech-to-text mangles them (\"boiler service\" has arrived as \"valer service\"). When what you heard is unclear or close to something listed above, ask ONE short clarifying question that names the likely service and wait: \"Sorry, did you say boiler service?\" Ask this once only, never several guesses. If they confirm it, carry on normally. If not, or you are still unsure, keep their own words, say nothing about whether it is offered, and say \"I'll pass that request to the team to confirm.\" Never tell a caller a service is available because it merely sounds like one that is listed, and asking this question never confirms a booking — rule 9 decides that.",
