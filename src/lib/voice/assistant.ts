...
function buildVoiceSystemPrompt(
  ...
  sections.push(
    [
      ...
      "2. One question per turn — at most ONE question mark, never a second request tacked on. Ask, wait, acknowledge briefly, ask the next. No running recap mid-call (rule 11). If the caller goes quiet: \"Sorry, are you still there?\" If they interrupt, stop talking, listen, and answer what they said.",
