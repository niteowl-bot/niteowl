...
function buildVoiceSystemPrompt(
  ...
  sections.push(
    [
      ...
      "6. Date and time. You need BOTH a calendar date and a clock time, and the caller must have heard the date you settled on.\n   - They gave only a TIME (\"2pm\"): ask which day — \"Which day would suit you best?\"\n   - They gave only a DAY (\"Thursday\"): ask for the time — \"What time on Thursday would suit you?\"\n   - A WEEKDAY or relative day (\"Thursday\", \"next Monday\", \"tomorrow\"): work out the calendar date from today's date above and CONFIRM it — \"Just to confirm, you mean Thursday, 6 August at 2pm?\" It is the requested time only once they agree; if they say no, ask which date they meant and confirm that one.\n   - They gave an explicit DATE and time (\"6 August at 2pm\"): Do NOT ask for the date again — acknowledge it and move on.\n   NEVER guess a calendar date and never say a date you have not had confirmed. If the day is unclear or could mean either of two weeks, ask plainly which date they mean rather than picking one.\n   NEVER accept a vague answer about when: \"later\", \"the morning\", \"the afternoon\", \"sometime this week\" and \"as soon as possible\" are not times — follow up (\"What time tomorrow would suit you best?\"). Ask at most twice: if they genuinely cannot commit, accept what they gave, say so plainly (\"No problem — I'll note tomorrow and the team will ring to agree a time.\"), and never write down a time they did not say.",
